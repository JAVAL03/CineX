...
.then((data) =>{
    ...
    document.getElementById('title').innerText = data[12].name;
    document.getElementById('details').innerText = data[12].detail;
    document.getElementById('gen').innerText = data[12].genre;
    document.getElementById('date').innerText = data[12].date;
    document.getElementById('rate').innerHTML = `
    <span>IMDB</span><i class="bi bi-star-fill"></i>${data[12].imdb}
    `;
